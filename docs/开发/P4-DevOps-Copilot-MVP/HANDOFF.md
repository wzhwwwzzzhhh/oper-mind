...
本文件仅记录已关闭的 Work 1。P4.1 已在后续工作包完成并通过真实 smoke；P4.2 已完成独立 Design/Review。项目级下一步以 `../_A-Plan-总览.md` 为准：当前等待用户明确确认 P4.2 Design 的实施，不能提前修改 P4.2 的运行时代码、API、前端、迁移或真实连接。
