...
本文件仅记录已关闭的 Work 1。P4.1/P4.2 已在后续工作包完成并通过真实 smoke；P4.3 也已完成代码、迁移、API、UI 与回归。项目级唯一下一步以 `../_A-Plan-总览.md` 为准：P4.3 已通过真实 target smoke；当前进入 P5.0 Design，不得把本历史 HANDOFF 误读为当前停止点。
