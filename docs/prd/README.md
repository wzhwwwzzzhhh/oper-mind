...
| P8 | 审计操作记录——跨服务跨会话的活动检索 | `audit/P8-audit-activity-log.md` | 进行中 |
| P8 | 模型可用列表探测——Provider 侧模型枚举 | `model/P8-model-list-enumeration.md` | 进行中 |
| P8 | 会话管理——全局 Run 列表与会话搜索 | `session/P8-session-management.md` | 进行中 |
