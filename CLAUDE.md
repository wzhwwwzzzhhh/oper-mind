...
- 当前唯一下一步以 A-Plan 为准：**P3.2 v1 API 客户端与会话恢复读模型的 Design 已完成并通过独立审查，待用户授权暂存/提交**；提交后的唯一下一步为 **P3.2a OpenAPI 类型、v1 API 客户端与 MSW 契约实现**。P3.1 已提交为 `4862752 feat: 初始化P3主前端工程与产品外壳`，P2.5 已提交为 `54f02e5 feat: 完成P2.5刷新恢复与闭环验收`。
